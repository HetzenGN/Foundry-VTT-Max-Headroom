...
Do this before configuring Foundry.
...
8. Switch to the **Chat Widget** tab and open the provided URL shown there. If Discord asks for permissions during this process, accept them.
...
The GM who will act as Relay Host must install the Max Headroom Companion extension.
...
Open **Configure Settings → Module Settings** in Foundry and find the Max Headroom settings.
